...
def flatten_observation(static_state: dict[str, Any], dynamic_state: dict[str, Any]) -> torch.Tensor:
    ...
    Returns:
        Normalized feature tensor (56 dims)
    """
    features: list[float] = []
    ...
    features.extend([
        ...
        normalize_range(e["ArmorKnockbackModifier"], 0.4, 1.2),
        normalize_range(e["ArmorSpeedModifier"], 0.65, 1.25),
    ...
    features.extend([
        ...
        normalize_01(p["Health"], p["MaxHealth"]),
    ...
    features.extend([
        ...
        normalize_01(b["Health"], b["MaxHealth"]),
    ])
